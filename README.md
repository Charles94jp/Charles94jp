<head>
    ...
    <link rel="stylesheet" media="all"
        href="https://github-atom-io-herokuapp-com.freetls.fastly.net/assets/application-3cb78c62c5521ca313c78178e3e82ccb1695af1c72a01a79d82ac9fadcbdec6c.css"
        data-turbolinks-track="true">

</head>
<body class="is-responsive" style="background:#574c4f">
    <div class="hero-header-item hero-logo" aria-hidden="true" style="position:relative; top:66px;">
        <div class="hero-logo-circles" >
            <img class="hero-logo-circle"
        ...
        <img class="hero-octonaut"
            src="https://github-atom-io-herokuapp-com.freetls.fastly.net/assets/index-octonaut-8ece2623b8966578e2414c89b7b7190cb56339d1f8b7d260adf62110ce9f39c4.svg"
            style="position:relative; top:-360px;left: calc(58.5% - 520px);">
    </div>
</body>